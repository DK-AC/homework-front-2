...
function Clock() {
  ...
  const start = () => {
    ...
    stop() // isso garante que o timer antigo, se existir, seja limpo antes de iniciar um novo
  ...
  const onMouseEnter = (e: MouseEvent) => { // пишут студенты // показать дату если
    // наведена мышк
  ...
  // (01:02:03)/(23:02:03)/(24:00:00)/(00:00:01) // пишут студенты
  const stringDate = new Intl.DateTimeFormat('ru-Ru', {
    year: 'numeric',
    month: 'numeric',
    day: 'numeric'
  }).format(date) || <br/> // день.месяц.год
  // (01.02.2022) // пишут студенты, варианты 01.02.0123/01.02.-123/01.02.12345 не рассматриваем
